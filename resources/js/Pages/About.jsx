            ...
            <section className="flex flex-col items-center justify-center text-white py-20 px-6">
                ...
                {/* Content Sections */}
                {
                    [
                        {
                            title: 'Our Journey',
                            text: 'Our story began with a simple idea: to bring the flavors of traditional Italian pizza to [Your Community]. With recipes perfected over years, we craft each pizza with love, using the finest ingredients for a truly authentic experience.'
                        },
                        {
                        ...
                        <div key={index} className="mt-10 max-w-3xl text-center">
                            ...
                            {section.text && <p className="leading-relaxed text-gray-300">{section.text}</p>}
                            {section.jsxContent && <div className="leading-relaxed text-gray-300">{section.jsxContent}</div>}
                        </div>
                    ))
                }
            </section>
